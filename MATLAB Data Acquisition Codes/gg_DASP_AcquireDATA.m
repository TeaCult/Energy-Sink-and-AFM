...
% set 
addpath('C:\Documents and Settings\Gediz\Desktop\MASTER CODES')
...
%% IMPULSE
sigIN=0*T;
sigIN(1:10)=sin(linspace(0,pi,10));



% ADDED Titles information for Plots 
titlesforPlots=([num2str(AMP), '*Sin(2*pi*',num2str(freqIN),'t) , Duration: ', num2str(duration), ' seconds']);
...
tempstr1=pwd;
if(~strcmp(tempstr1,'C:\Documents and Settings\Gediz\Desktop\DASP_CODE_IMP'))
cd 'C:\Documents and Settings\Gediz\Desktop\DASP_CODE_IMP'
end
